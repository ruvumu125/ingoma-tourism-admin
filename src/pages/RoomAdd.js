...
import {getPropertiesList} from "../utils/apiFunctions/propertyApiFunctions";
import {getRoomAmenitiesList} from "../utils/apiFunctions/amenityApiFunctions";
import {addRoom} from "../utils/apiFunctions/roomApiFunctions";
...
function RoomAdd() {
    ...
    const handleSubmit = (e) => {
        ...
        saveNewRoom().then(() => console.log("Room saved successfully"))
    ...
    const saveNewRoom = async () => {
        ...
        try {
            const success = await addRoom(hotelData);
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">
                                        {
                                            isPropertiesFetched && isRoomAmenitiesFetched ? (
                                                <>
                                                    <div className="row">
                                                                ...
                                                                {hotelData.amenities.map((amenity, index) => (
                                                                    <div className="row" key={index}>
                                                                        <div className="col-lg-4 col-sm-6 col-12">
                                                                            <div className="input-blocks add-product">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    id="autoSizingSelect" >
                                                                                    <option value={selectedRoomAmenityId}>{selectedRoomAmenityName}</option>
                                                                                    {
                                                                                        roomAmenities.map((amenity, index) => (
                                                                                            <option
                                                                                                key={index}
                                                                                                value={amenity.id}
                                                                                                selected={amenity.id===selectedRoomAmenityId}
                                                                                            >{amenity.name}</option>                                                        ))
                                                                                    }
                                                                                </select>
                                                                        ...
                                                                        <div className="col-lg-7 col-sm-6 col-12">
                                                                            <div className="input-blocks add-product">
                                                                                <label>Description de la commodité</label>
                                                                                <input
