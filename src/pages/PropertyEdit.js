...
import {getPropertyById, updateProperty} from "../utils/apiFunctions/propertyApiFunctions";
...
function PropertyEdit() {
    ...
    const [isPropertyDetailsFetched, setIsPropertyDetailsFetched] = useState(false);
    ...
    const handleSubmit = (e) => {
        ...
        updateSelectedProperty().then(() => console.log("Property saved successfully"))
    ...
    const updateSelectedProperty = async () => {

        setIsSaving(true);
        try {
            const success = await updateProperty(id, hotelData);
                            ...
                            <div className="accordion-item">
                                ...
                                <div id="collapseOne" className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">
                                        {
                                            isCitiesFetched && isHotelTypesFetched && isHotelAmenities && isPropertyDetailsFetched ? (
                                                <>
                                                    <div className="row">
                                                                ...
                                                                <select
                                                                    ...
                                                                    className={`form-select ${savingErrors.property_type ? "is-invalid" : ""}`}>
                                                                    {
                                                                        hotelData.property_type==="hotel" && (
                                                                            <option value="hotel" selected={"hotel"===hotelData.property_type==="hotel"}>Hôtel</option>
                                                                        )
                                                                    }
                                                                    {
                                                                        hotelData.property_type==="guesthouse" && (
                                                                            <option value="guesthouse" selected={"guesthouse"===hotelData.property_type==="guesthouse"}>Maison de passage</option>
                                                                        )
                                                                    }
...

                                                                    {
                                                                        cities.map((city, index) => (
                                                                            <option
                                                                                key={index}
                                                                                value={city.id}
                                                                                selected={city.id===hotelData.city_id}
                                                                            >{city.name}</option>                                                        ))
                                                                    }
                                                                </select>
...

                                                                            {
                                                                                hotelTypes.map((hotel_type, index) => (
                                                                                    <option
                                                                                        key={index}
                                                                                        value={hotel_type.id}
                                                                                        selected={hotel_type.id===hotelData.hotel_type}
                                                                    ...
                                                                    <div className="row" key={index}>
                                                                        <div className="col-lg-4 col-sm-6 col-12">
                                                                            <div className="input-blocks add-product">
                                                                                ...
                                                                                <select
                                                                                    value={amenity.amenity_id || propertyAmenities[index]?.id || ""}
                                                                                    onChange={(e) =>
                                                                                    ...
                                                                                    {
                                                                                        propertyAmenities.map((amenityOption, optionIndex) => (
                                                                                            <option
                                                                                                key={optionIndex}
